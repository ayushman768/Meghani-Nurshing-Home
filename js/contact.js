...
article.innerHTML +='<div class="container"><div class="row text-center"><h6>Contact Us</h6></div></div></div>';
...
var jason = [{
 ...
 document.querySelector('.article06>.container>.row').innerHTML +=`
   <div class="col-md-6">
       <div class="myContect pad-10">
	        <ul>
			    <li>${jason[0].ad}</li>
				<li><a href="tel:${jason[0].ph}">${jason[0].ph}</a></li>
				<li><a href="mailto:${jason[0].em}">${jason[0].em}</a></li>
