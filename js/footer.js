			    ...
			    <div class="col-md-4">
			       <div class="Meghani_nursing_home_nav">
					   ...
					   <ul class="navbar-nav nav pull-right">
						 <li class="my_btn"><a href="">${jason[0].side_nav07}</a></li>
						  <li class="my_btn"><a href="tel:${jason[0].side_nav08}">${jason[0].side_nav08}</a></li>
						  <li class="my_btn"><a href="mailto:${jason[0].side_nav09}">${jason[0].side_nav09}</a></li>
					   </ul>
			       </div>
			   </div>
		   </div>
